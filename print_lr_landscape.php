...
function render_lr_copy($copy_title, $shipment, $invoices, $company_details, $display_shipping_name, $display_shipping_address) {
    ...
    $total_invoice_value = array_sum(array_column($invoices, 'invoice_amount'));
    ?>
    <div class="lr-copy bg-white p-4 border border-gray-400 mb-8 shadow-lg font-sans text-xs">
        
        <div class="watermark-container">
            <img src="<?php echo htmlspecialchars($company_details['logo_path']); ?>" alt="Watermark">
        </div>

        <header class="text-center border-b-2 border-black pb-2">
        ...
        <div class="content-wrapper">
            <div class="grid grid-cols-12 gap-px mt-1">
                <div class="col-span-8 pr-1">
                    <div class="border border-1 border-black">
                        <div class="grid <?php echo $shipment['is_shipping_different'] ? 'grid-cols-3' : 'grid-cols-2'; ?> divide-x">
                            <div class="p-1 border-1 border-black">
                            ...
                            <div class="p-1 bg-yellow-50 border-1 border-black">
                    ...
                    <div class="border border-1 border-black mt-1">
                        <div class="grid grid-cols-2 divide-x border-1 border-black">
                            <div class="border-1 border-black p-1"><strong>From:</strong> <?php echo htmlspecialchars($shipment['origin']); ?></div>
                            <div class="border-1 border-black p-1"><strong>To:</strong> <?php echo htmlspecialchars($shipment['destination']); ?></div>
                        </div>
                    </div>
                    <div class="border border-1 border-black mt-1">
                        <div class="grid grid-cols-2 divide-x">
                            ...
                            <div class="p-1 border-1 border-black">
                                ...
                                <p><strong>Name:</strong> <?php echo htmlspecialchars($shipment['driver_name']); ?></p>
                                <p><strong>DL No.:</strong> <?php echo htmlspecialchars($shipment['driver_license']); ?></p>
                                <p><strong>Contact No.:</strong> <?php echo htmlspecialchars($shipment['driver_contact']); ?></p>
                ...
                <div class="col-span-4 pl-1">
                    ...
                    <div class="border border-1 border-black text-center">
                        <div class="grid grid-cols-2 divide-x border-1 border-black">
                            <div class="p-1 border-1 border-black"><strong>Date:</strong><br><?php echo date("d-m-Y", strtotime($shipment['consignment_date'])); ?></div>
                            <div class="p-1 border-1 border-black"><strong>Vehicle No:</strong><br><?php echo htmlspecialchars($shipment['vehicle_number']); ?></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="border border-1 border-black mt-1">
                <div class="grid grid-cols-2 divide-x border-1 border-black">
                    <div class="p-1 border-1 border-black">
                        <table class="w-full border-1 border-black border-collapse">
                            <thead class="font-bold">
                                <tr class="text-left">
                                    <th class="border border-1 border-black p-1">Invoice No.</th>
                                    <th class="border border-1 border-black p-1">Invoice Date</th>
                                    <th class="border border-1 border-black p-1">Value</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach($invoices as $inv): ?>
                                <tr>
                                    <td class="border border-1 border-black p-1"><?php echo htmlspecialchars($inv['invoice_no']); ?></td>
                                    <td class="border border-1 border-black p-1"><?php echo date("d-m-Y", strtotime($inv['invoice_date'])); ?></td>
                                    <td class="border border-1 border-black p-1"><?php echo number_format($inv['invoice_amount'], 2); ?></td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
                    ...
                    <div class="p-1">
                        <table class="w-full border border-1 border-black border-collapse">
                            <thead class="font-bold">
                                <tr class="text-left">
                                    <th class="border border-1 border-black p-1">E-Way Bill No.</th>
                                    <th class="border border-1 border-black p-1">Valid Upto</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach($invoices as $inv): ?>
                                <tr>
                                    <td class="border border-1 border-black p-1"><?php echo htmlspecialchars($inv['eway_bill_no']); ?></td>
                                    <td class="border border-1 border-black p-1"><?php echo date("d-m-Y", strtotime($inv['eway_bill_expiry'])); ?></td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
            ...
            <table class="w-full mt-1 border-collapse border-1 border-black text-center">
                <thead>
                    <tr class="font-bold"><td class="border border-1 border-black p-1">Quantity</td><td class="border border-1 border-black p-1">Description (Said to Contain)</td><td class="border border-1 border-black p-1">Actual Weight</td><td class="border border-1 border-black p-1">Chargeable Weight</td><td class="border border-1 border-black p-1">Rate</td><td class="border border-1 border-black p-1">Invoice Value</td><td class="border border-1 border-black p-1">Paid / To Pay / To be Billed At</td></tr>
                </thead>
                <tbody>
                    <tr class="h-12 align-top"><td class="border border-1 border-black p-1"><?php echo htmlspecialchars($shipment['quantity']); ?> <?php echo htmlspecialchars($shipment['package_type']); ?></td><td class="border border-1 border-black p-1"><?php echo htmlspecialchars($shipment['description_text']); ?></td><td class="border border-1 border-black p-1"><?php echo htmlspecialchars($shipment['net_weight'].' '.$shipment['net_weight_unit']); ?></td><td class="border border-1 border-black p-1"><?php echo htmlspecialchars($shipment['chargeable_weight'].' '.$shipment['chargeable_weight_unit']); ?></td><td class="border border-1 border-black p-1">FIXED</td><td class="border border-1 border-black p-1">₹<?php echo number_format($total_invoice_value, 2); ?></td><td class="border border-1 border-black p-1"><?php echo htmlspecialchars($shipment['billing_type']); ?></td></tr>
                </tbody>
            </table>
            
            <div class="border border-1 border-black mt-1">
                <div class="grid grid-cols-2 divide-x">
                    <div class="p-1 border border-1 border-black">
                    ...
                    <div class="p-1 h-20 border border-1 border-black"><p class="font-bold">Receiver's Seal & Signature:</p></div>
...
<head>
    ...
    <style>
        ...
        .lr-copy { 
            width: 297mm; 
            height: 205mm; /* A4 Landscape dimensions */ 
            margin-left: auto; 
            margin-right: auto;
        ...
        .watermark-container img {
            opacity: 0.1; /* Faintness of the watermark */
            width: 50%;   /* Size of the watermark */
            height: auto;
            max-height: 80%;
            object-fit: contain;
        }
        .content-wrapper {
            position: relative;
            z-index: 1; /* Places the content above the watermark */
        }
        ...
        @media print {
            ...
            .lr-copy {
                ...
                /* START: CORRECTED WIDTH AND CENTERING */
                width: 287mm; /* Reduced width to account for unprintable margins */
                margin: 0 auto; /* Center the narrower container on the page */
                /* END: CORRECTED WIDTH AND CENTERING */

                height: 208mm; /* Slightly reduced height for top/bottom margins */
                padding: 5mm;
                border: none;
                box-shadow: none;
