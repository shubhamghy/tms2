                    ...
                    <form method="POST" id="select-party-form">
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                            ...
                            <div>
                                ...
                                <select id="party_id" name="party_id" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" required>
